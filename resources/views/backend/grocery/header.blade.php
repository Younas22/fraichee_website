...
{{--    @endforeach--}}
    <link href="{{url('public/assets/grocery-crud/css/grocery-crud-v2.7.8.a4867fc.css')}}" rel="stylesheet">
    <link href="{{url('public/assets/grocery-crud/css/jquery-plugins/select2.css')}}" rel="stylesheet">
    {{-- end grocery-crud --}}
