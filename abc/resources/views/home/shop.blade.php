                    ...
                    <div class="card-body">
                        <div class="row align-items-md-center">
                            <div class="col-3 col-md-2 text-center">
                                <img class=" img-wash" src="<?= url('public/assets/web/img/bed-linen.png') ?>" alt="Generic placeholder image" width="48px" height="48px">
                            </div>
                            <div class="col-9 col-md-8 px-0">
                                <h5 class="mt-0 card-title"><?=$key->name?></h5>
                                <p class="mb-2 card-text"><?=$key->desc?></p>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer d-none">
                                                <button type="button" class="btn btn-primary py-3 w-100">Add to Cart</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<h4>Laundry</h4>
            <?php foreach ($laundary as $key): ?>
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-md-center">
                            <div class="col-3 col-md-2 text-center">
                                <img class=" img-wash" src="<?= url('public/assets/web/img/laundry.png') ?>" alt="Generic placeholder image" width="48px" height="48px">
                            </div>
                            <div class="col-9 col-md-8 px-0">
                                <h5 class="mt-0 card-title"><?=$key->name?></h5>
                                <p class="mb-2 card-text"><?=$key->desc?></p>
            ...
            <div class="col-md-4">
                ...
                <section class="summary">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title pb-2">Order summary</h6>
                            <!-- <p class="mb-2">Add items to start estimating...</p> -->
                            <ul class="navbar-nav flex-column" style="border-top: none !important;">
